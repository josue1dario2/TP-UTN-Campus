...
Materia::Materia(int idMateria, int idCarrera, const char* nombre, int cuatrimestre,const char* estado, bool eliminado = false) {
...
void Materia::setCuatrimestre(int cuatrimestre) {
...
int Materia::getCuatrimestre() const {
